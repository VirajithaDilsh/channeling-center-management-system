...
const AddMedicine = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      alert(isEdit ? "Failed to update medicine" : "Failed to add medicine");
    } finally {
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-1">
          ...
          <div className="lg:col-span-1 bg-white shadow rounded-xl space-y-6 p-6 mt-6 self-start">
            <h3 className="font-semibold text-slate-800  mb-5">Summary</h3>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between py-2 border-b border-slate-100 ">
                  ...
                  <span className="font-medium text-slate-900 ">
                    {form.stockQuantity
                      ? `${form.stockQuantity} ${form.unitType}`
                      : "—"}
                  </span>
                </div>
                <div className="flex justify-between py-2 border-b border-slate-100 ">
              ...
              {form.stockQuantity && form.unitPrice && (
                <div className="mt-4 p-3 bg-sky-50 dark:bg-sky-900/20 rounded-xl">
                  <div className="flex justify-between text-sm">
                    <span className="text-sky-700 ">Total Value</span>
